...
try
    ...
    [xMicroscope, yMicroscope, zMicroscope] = world2Microscope(surgicalTip_3D(1), surgicalTip_3D(2), surgicalTip_3D(3)); %World to Microscope Coordinate Mapping
    elapsed_3(k) = toc;
...
%Vertical 50
% [Tracked_Displacement,Accuracy] = trackingAccuracy(surgicalTip_Accuracy(2,:),50);
